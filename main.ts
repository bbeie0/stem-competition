controller.B.onEvent(ControllerButtonEvent.Pressed, function () {
    if (true) {
        projectile = sprites.createProjectileFromSprite(assets.image`banana`, Jasper, 100, 0)
    }
})
...
controller.right.onEvent(ControllerButtonEvent.Released, function () {
    animation.stopAnimation(animation.AnimationTypes.All, Jasper)
    Jasper.setImage(img`
        . . . . . . . f f f f f . . . . 
        . . . . . . f e e e e e f . . . 
        . . . . . f e e e d d d d f . . 
...
Jasper = sprites.create(img`
    ...
    . . f f f f f f f f f f f f f . 
    `, SpriteKind.Player)
tiles.placeOnTile(Jasper, tiles.getTileLocation(11, 4))
scene.cameraFollowSprite(Jasper)
controller.moveSprite(Jasper, 100, 0)
let Banana_Bomb = sprites.create(assets.image`banana`, SpriteKind.Food)
